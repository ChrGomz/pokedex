    ...
    ModalNavigationDrawer(
        ...
        Scaffold(topBar = {
            ...
            Surface(modifier = Modifier
                ...
                NavHost(
                    navController = navController, startDestination = Rutas.PantallaTesting.ruta
                ) {
...
fun TopBar(lightTheme: Boolean, settingsState: Boolean, onNavClick: () -> Job) {
    ...
    if (settingsState) {
        TopAppBar(colors = TopAppBarDefaults.topAppBarColors(containerColor = colorScheme.primaryContainer.copy(alpha = 0.2f)),
            title = {
            Text(text = "Pokedex")
        }, navigationIcon = {
            IconButton(onClick = {
...
fun BottomBar(lightTheme: Boolean, navController: NavHostController) {
    BottomAppBar (containerColor = MaterialTheme.colorScheme.primaryContainer.copy(alpha = 0.2f)) {
        Row(
            ...
            BottomBarButton(
                onClick = { navController.navigate(Rutas.PantallaTesting.ruta) },
                lightTheme = lightTheme,
